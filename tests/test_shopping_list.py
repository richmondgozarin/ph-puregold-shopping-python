...
class ShoppinglistTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.shoppinglist = {'store_name': 'puregold'}
    ...
    def test_shoppinglist_creation(self):
        ...
        self.assertIn('puregold', str(res.data))
    ...
    def test_shoppinglist_can_be_edited(self):
        ...
        self.assertIn('supermarket', str(results.data))
